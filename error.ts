...
/**
 * This class provides a wrapper for network errors when making requests to Zapier AI Actions API
 */
export class ZapierActionsError extends Error {
  /**
   * The response body
   */
